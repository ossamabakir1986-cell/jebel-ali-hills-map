...
(function(){
  ...
  window.startAddPlotByMapClick = function(){
    ...
    map.once('click', function(e){
      ...
      ['editGisPlot','editMasterPlot','editAgent','editMobile','editPrice','editSecondAgent','editSecondMobile','editSecondPrice','editComment'].forEach(function(id){ var el=document.getElementById(id); if(el) el.value=''; });
