...
var map = L.map('map', { zoomControl:false, preferCanvas:true, updateWhenIdle:true, updateWhenZooming:false, wheelDebounceTime:60 }).setView([24.900313373804266, 54.975459621044884], 16);
window.map = map;
