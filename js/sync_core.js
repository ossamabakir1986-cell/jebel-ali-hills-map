  ...
  window.exportFullWebsitePackage = async function(){
    try {
      ...
      var textFiles = [
        ...
        'js/v3320_clean_fast_filters_features.js',
        'js/v3321_restore_feature_bulk_and_pa_add.js',
        'js/v3322_pa_alignment_move_plot_restore.js',
        'js/v3323_move_plot_map_click_pa_add_repair.js',
        'js/v3324_pa_add_hotspot_repair.js',
        'js/v3325_pa_add_visible_badges_final.js',
        'js/v3326_multi_display_labels_restore.js',
